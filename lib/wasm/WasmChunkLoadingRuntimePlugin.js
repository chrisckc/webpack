 ...
 */
const generateImportObject = (chunkGraph, module, mangle, declarations) => {
...
class WasmChunkLoadingRuntimePlugin extends RuntimeModule {
	constructor(
		chunk,
		compilation,
...
module.exports = WasmChunkLoadingRuntimePlugin;
